      ...
      <div className="mx-auto max-w-7xl w-full pt-8 pb-20 text-center lg:py-48 lg:text-left">
        <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
          ...
          <p className="mt-3 max-w-md mx-auto text-lg text-gray-600 sm:text-xl md:mt-5 md:max-w-3xl">
            ...
            marketplace where you can rent anything. I oversee the platform and
            I designed the majority of the app. My motivation to learn to code
            is to be more hands on in continued development of Yoodlize.
            <br></br>I also have a food services company called Bee's Kitchen. I
            have three almost grown children, two 100 lb. dogs, and a husband
            who is also my co-founder. I am about 500 hrs into the 10,000 hours
            it takes to become a master software engineer!
          </p>
